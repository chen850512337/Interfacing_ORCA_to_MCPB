...
#> chenjf
from pymsmt.mol.orcaio import get_esp_from_orca
...
def resp_fitting(stpdbf, lgpdbf, stfpf, lgfpf, mklogf, ionids,\
    ...
    #> chenjf
        ...
        # Atom positoin and ESP fitting points, both are generated by Multiwfn
        chgf = mklogf.strip('.log') + '.chg'
        eptf = mklogf.strip('.log') + '.espfpt'
        get_esp_from_orca(chgf, eptf, espf)
