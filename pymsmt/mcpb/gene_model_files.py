...
from pymsmt.mol.gmsio import (write_gmsatm, write_gms_optf, write_gms_fcf,
                             write_gms_mkf)
#>chenjf
from pymsmt.mol.orcaio import (write_orca_optf, write_orca_mkf)
...
def build_small_model(mol, reslist, ionids, cutoff, smresids, smresace,
    ...
    #> chenjf
    # ORCA
    # using only one file is enough because ORCA is much flexible 
    ooptf = outf + '_orca_small_opt.inp'
    ...
    # ORCA
    # only one is enough
    write_orca_optf(ooptf, smchg, SpinNum, gatms)
...
def build_large_model(mol, reslist, lmsresids, lmsresace, lmsresnme,
    ...
    # chenjf write out orca large model
    omkf = outf + '_orca_large_mk.inp'
    ...
    #For ORCA file
    #>chenjf
    write_orca_mkf(omkf, lgchg, SpinNum, gatms, largeopt)
